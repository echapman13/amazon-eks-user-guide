...
.. Under *Prerequisite - Prepare template*, make sure that *Choose an existing template* is selected and then under *Specify template*, select *Amazon S3 URL*.
...
.. From the navigation bar, select an {aws} Region that supports Amazon EKS.
.. Choose *Create stack*, *With new resources (standard)*.
.. Under *Prepare template*, make sure that *Choose an existing template* is selected and then under *Template source*, select *Amazon S3 URL*.
